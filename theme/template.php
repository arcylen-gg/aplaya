...
<html lang="en">
    <head>
        ...
        <title>El Marfin Pavilion: <?php echo $title; ?></title>
        <!-- Bootstrap core CSS -->
        <link href="<?php echo WEB_ROOT; ?>css/bootstrap.min.css" rel="stylesheet">
        <!-- <link href="<?php echo WEB_ROOT; ?>css/bootstrap-datetimepicker.min.css" rel="stylesheet" media="screen"> -->
        <link rel="stylesheet" type="text/css" href="../jquery/bootstrap-datetimepicker-standalone.min.css">
        <!--   <script type="text/javascript" language="javascript" src="<?php echo WEB_ROOT; ?>jquery/jquery-3.3.1.min.js"></script> -->
        ...
        <div class="navbar navbar-fixed-top navbar-inverse"  role="navigation">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <!-- <a class="navbar-brand" href="<?php echo WEB_ROOT; ?>index.php">El Marfin Resort</a>    -->
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<?php echo WEB_ROOT; ?>booking/"></span> Booking List (<?php echo $cart;?>)</a> </li>
