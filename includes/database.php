...
class Database {
	...
	/*mysql_connect*/ /*CHANGE mysql_connect to mysqli_connect */
	/*mysql_select_db*/ /*CHANGE mysql_select_db to mysqli_select_db */
	/*mysql_qudery*/ /*CHANGE mysql_qudery to mysqli_query */
	/*mysqli_fetch_assoc*/ /*CHANGE mysql_fetch_assoc to mysqli_fetch_assoc */
	...
	public function open_connection() {
		...
		if(!$this->conn){
			...
			exit();*/
			die("Problem in database connection! Contact administrator!". mysqli_error());
		}else{
